...
if ( ! class_exists( 'NandotessResume' ) ) :
	...
	class NandotessResume {
		...
		public function scripts() {
			...
			wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/assets/vendor/bootstrap/css/bootstrap.min.css', array(), $nandotess_resume_version, 'all' );
			...
			wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/assets/vendor/font-awesome/css/font-awesome.min.css', array(), $nandotess_resume_version, 'all' );

			wp_enqueue_style( 'nandotess-resume-style', get_template_directory_uri() . '/assets/css/nandotess-resume.css', array(), $nandotess_resume_version, 'all' );
